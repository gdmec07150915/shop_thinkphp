...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <form action="/shop/index.php/Admin/Goods/xiugai" method="post" enctype="multipart/form-data"> --><!-- 不能用action没有goods_id的参数传过来，另一边的xiugai($goods_id)会报错 -->
            <form action="/shop/index.php/Admin/Goods/xiugai/goods_id/8" method="post" enctype="multipart/form-data">
