...
<link href="<?php echo ADMIN_CSS_URL ; ?>login.css" type="text/css" rel="stylesheet" />
    ...
    <dl>
        ...
        <dd id="user_main">
            <ul>
                ...
                <li class="user_main_r"><input type="image" name="IbtnEnter" src="<?php echo ADMIN_IMG_URL ;?>user_botton.gif" class="ibtnentercssclass"></li>
            </ul>
        </dd>
        <dd id="user_bottom">
            <ul>
