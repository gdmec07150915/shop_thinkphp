...
<!-- start details -->
<link rel="stylesheet" type="text/css" href="<?php echo CSS_URL; ?>productviewgallery.css" media="all" />
<script type="text/javascript" src="<?php echo JS_URL; ?>jquery.min.js"></script>
<script type="text/javascript" src="<?php echo JS_URL; ?>cloud-zoom.1.0.3.min.js"></script>
<script type="text/javascript" src="<?php echo JS_URL; ?>jquery.fancybox.pack.js"></script>
<script type="text/javascript" src="<?php echo JS_URL; ?>jquery.fancybox-buttons.js"></script>
<script type="text/javascript" src="<?php echo JS_URL; ?>jquery.fancybox-thumbs.js"></script>
<script type="text/javascript" src="<?php echo JS_URL; ?>productviewgallery.js"></script>
<!-- start top_js_button -->
<script type="text/javascript" src="<?php echo JS_URL; ?>jquery.min.js"></script>
...
<div class="wrap">
    <div class="header_sub">
        ...
        <div class="top-nav">
              ...
              <div class="clear"> </div>
              <script src="<?php echo JS_URL; ?>responsive.menu.js"></script>
         </div>
    <div class="clear"></div>
</div>
</div>
            ...
            <div class="span1_of_1">
                ...
                <div class="product-view">
                    ...
                    <div class="product-image">
                        <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href="<?php echo IMG_URL; ?>0001-2.jpg" title="Women Shorts" alt="Women Shorts">
                            <img src="<?php echo IMG_URL; ?>0001-2.jpg" alt="Women Shorts" title="Women Shorts" />
                        </a>
                   </div>
                    <script type="text/javascript">
                        var prodGallery = jQblvg.parseJSON('{"prod_1":{"main":{"orig":"<?php echo IMG_URL; ?>0001-2.jpg","main":"<?php echo IMG_URL; ?>large/0001-2.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-2.jpg","label":""},"gallery":{"item_0":{"orig":"<?php echo IMG_URL; ?>0001-2.jpg","main":"<?php echo IMG_URL; ?>large/0001-2.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-2.jpg","label":""},"item_1":{"orig":"<?php echo IMG_URL; ?>0001-1.jpg","main":"<?php echo IMG_URL; ?>large/0001-1.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-1.jpg","label":""},"item_2":{"orig":"<?php echo IMG_URL; ?>0001-5.jpg","main":"<?php echo IMG_URL; ?>large/0001-5.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-5.jpg","label":""},"item_3":{"orig":"<?php echo IMG_URL; ?>0001-3.jpg","main":"<?php echo IMG_URL; ?>large/0001-3.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-3.jpg","label":""},"item_4":{"orig":"<?php echo IMG_URL; ?>0001-4.jpg","main":"<?php echo IMG_URL; ?>large/0001-4.jpg","thumb":"<?php echo IMG_URL; ?>small/0001-4.jpg","label":""}},"type":"simple","video":false}}'),
                  ...
                  <div class="desc1">
                    ...
                    <div class="share-desc">
                        <div class="share">
                            <h4>Share Product :</h4>
                            <ul class="share_nav">
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>facebook.png" title="facebook"></a></li>
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>twitter.png" title="Twiiter"></a></li>
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>rss.png" title="Rss"></a></li>
                                <li><a href="#"><img src="<?php echo IMG_URL; ?>gpluse.png" title="Google+"></a></li>
                            </ul>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="sellers">
                        ...
                        <div class="single-nav">
                          ...
                          <div class="banner-wrap bottom_banner color_link">
                                ...
                                <figure><img src="<?php echo IMG_URL; ?>delivery.png" alt=""></figure>
...
<div class="wrap">
    <div class="footer">
        ...
        <!--end scroll_top_btn -->
        <div class="copy">
            <p class="link">Copyright &copy; 2014.Company name All rights reserved.<a target="_blank" href="http://www.mycodes.net/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
        </div>
        <div class="clear"></div>
    </div>
</div>
