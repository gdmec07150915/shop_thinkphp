...
<html>
<head>
<title>The Aditii Website Template | Handbags </title>
    ...
    <div class="main">
        ...
        <div class="grids_of_3">
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic1.jpg" alt=""/>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic2.jpg" alt=""/>
                    <h3>branded handbags</h3>
                    <div class="price">
                        <h4>$299 <span>indulge</span></h4>
                    </div>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic3.jpg" alt=""/>
                    <h3>branded handbags</h3>
                    <div class="price">
                        <h4>$299<span>indulge</span></h4>
                    </div>
        ...
        <div class="grids_of_3">
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic4.jpg" alt=""/>
                    <h3>branded handbags</h3>
                    <div class="price">
                        <h4>$299<span>indulge</span></h4>
                    </div>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic5.jpg" alt=""/>
                    <h3>branded handbags</h3>
                    <div class="price">
                        <h4>$299<span>indulge</span></h4>
                    </div>
            ...
            <div class="grid1_of_3">
                <a href="details.html">
                    <img src="<?php echo IMG_URL; ?>w_pic6.jpg" alt=""/>
                    <h3>branded handbags</h3>
                    <div class="price">
                        <h4>$299<span>indulge</span></h4>
                    </div>
